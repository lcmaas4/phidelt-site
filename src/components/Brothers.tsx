      ...
      <div className="exec-wrapper">
        ...
        <div className="exec-people-wrapper">
          ...
          <div className="exec-brother-container">
            ...
            <div className="brother-info">
              <p>
                Andrew Ow<br></br>Recruitment Chairman
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="council-wrapper">
        ...
        <div className="council-people-wrapper">
          ...
          <div className="council-brother-container">
            ...
            <div className="brother-info">
              <p>
                Arnav Sharma<br></br>Risk Management Chairman
              </p>
            </div>
          </div>
          <div className="council-brother-spacer-1"></div>
          ...
          <div className="council-brother-container">
            ...
            <div className="brother-info">
              <p>
                Conor Kilcullen<br></br>Alumni Secretary
              </p>
            </div>
          </div>
          <div className="council-brother-container">
          ...
          <div className="council-brother-container">
            ...
            <div className="brother-info">
              <p>
                Carter Olson<br></br>Public Relations Chairman
              </p>
            </div>
          </div>
          <div className="council-brother-container">
            ...
            <div className="brother-info">
              <p>
                Mason Dubanowitz<br></br>Scholarship Co-Chairman
              </p>
            </div>
          </div>
          <div className="council-brother-container">
            ...
            <div className="brother-info">
              <p>
                Andreas Gesser<br></br>Scholarship Co-Chairman
              </p>
            </div>
          </div>
          <div className="council-brother-container">
            ...
            <div className="brother-info">
              <p>
                Gaurav Koratagere<br></br>Philanthropy Chairman
              </p>
            </div>
          </div>
          <div className="council-brother-container">
            ...
            <div className="brother-info">
              <p>
                Jake Eisner<br></br>Community Service Chairman
              </p>
            </div>
          </div>
          <div className="council-brother-container">
            ...
            <div className="brother-info">
              <p>
                Mitchell Petrecca<br></br>Chorister
              </p>
            </div>
          </div>
          <div className="council-brother-container">
            ...
            <div className="brother-info">
              <p>
                Theo Smith<br></br>Awards Chairman
              </p>
            </div>
          </div>
          <div className="council-brother-container">
            ...
            <div className="brother-info">
              <p>
                Grey Vachon<br></br>SVP Chairman
              </p>
            </div>
          </div>
          <div className="council-brother-container">
            ...
            <div className="brother-info">
              <p>
                Vivek Singh<br></br>Merchandise Chairman
              </p>
            </div>
          </div>
          <div className="council-brother-spacer-1"></div>
